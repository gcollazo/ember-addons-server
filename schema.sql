...
-- ----------------------------
--  Sequence structure for addos_id_seq
-- ----------------------------
...
CREATE TABLE "public"."addons" (
	"id" int4 NOT NULL DEFAULT nextval('addos_id_seq'::regclass),
...
-- ----------------------------
ALTER SEQUENCE "public"."addos_id_seq" RESTART 1855 OWNED BY "addons"."id";
